...
public class ExtendedResolver implements Resolver {
  ...
  private static class Resolution implements ResolverListener {
    ...
    public Message start() throws IOException {
      try {
        /*
         * First, try sending synchronously. If this works, we're done. Otherwise, we'll get an
         * exception and continue. It would be easier to call send(0), but this avoids a thread
         * creation. If and when SimpleResolver.sendAsync() can be made to not create a thread, this
         * could be changed.
         */
        sent[0]++;
        outstanding++;
        ...
        /*
         * This will either cause more queries to be sent asynchronously or will set the 'done'
         * flag.
         */
    ...
    public void handleException(Object id, Exception e) {
      ...
      synchronized (this) {
        ...
        /*
         * If this is the first response from server n, we should start sending queries to server n
         * + 1.
         */
