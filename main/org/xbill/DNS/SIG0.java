...
public class SIG0 {
   ...
   */
  public static void signMessage(Message message, KEYRecord key, PrivateKey privkey, SIGRecord previous)
   ...
   *        the message in wire format, and we can't recreate the exact wire format (with the same
   *        name compression).
