...
public class SimpleResolver implements Resolver {
  ...
  public Message send(Message query) throws IOException {
    ...
    do {
      ...
      /*
       * Check that the response ID matches the query ID. We want to check this before actually
       * parsing the message, so that if there's a malformed response that's not ours, it doesn't
       * confuse us.
       */
